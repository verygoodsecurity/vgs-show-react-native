...
const cases = loadSdkBehaviorCases("text-pipeline");

/**
 * Covers masking, formatting, secure ranges, copy selection, and warning behavior.
 * Each case description states the SDK behavior being protected.
 */
describe("text pipeline behavior", () => {
