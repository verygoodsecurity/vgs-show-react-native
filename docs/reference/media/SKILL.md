...
- `Using @vgs/show-react-native 1.1.0.`
- `Detected @vgs/show-react-native 1.1.0 from package-lock.json.`
- `Could not determine the installed @vgs/show-react-native version; using latest guidance from the default branch.`
- `Exact tag 1.1.1 was not found; using nearest compatible tag 1.1.0.`
